...
/** Callback ID for the "Send to Benvu" modal submission. */
export const SEND_TO_BENVU_CALLBACK = 'send_to_benvu_submit';
...
/**
 * Build the "Send to Benvu" modal: a preview of the message plus a required
